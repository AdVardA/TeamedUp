...
class user_main_form(forms.ModelForm):
   ...
   # whats_app = forms.BooleanField(
    ...
    act = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}), label='ACT',
        label_suffix='', help_text='<a style = "color: #9933ff;" href = "https://www.act.org/" > Click <a/>')

    toefl = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}), label='TOEFL',
        label_suffix='', help_text='<a style = "color: #9933ff;" href = "https://www.ets.org/toefl" > Click <a/>')

    ielts = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}), label='IELTS',
        label_suffix='', help_text='')
    ...
    pay_or_not = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}),
        label='Pay or not', label_suffix='')
    league_resolution = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}),
    ...
    national_teem = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={'class': 'form-check-input', 'style': 'margin-left: auto;'}),
